...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    main: function() {
      var t, t1;
      t = new Y.Tree();
      t.head = new B.Node("p0", H.setRuntimeTypeInfo([], [V.Opr]), false);
      t1 = [P.String];
      t.addOpr$3("p0", 5, H.setRuntimeTypeInfo(["p1", "p2"], t1));
      t.addOpr$3("p0", 19, H.setRuntimeTypeInfo(["p3"], t1));
      t.addOpr$3("p0", 8, H.setRuntimeTypeInfo(["p5", "p4"], t1));
      t.addOpr$3("p4", 20, H.setRuntimeTypeInfo(["p11", "p12"], t1));
      t.addOpr$3("p4", 10, H.setRuntimeTypeInfo(["p10"], t1));
      H.printString(t.toString$0(0));
    }
  }, 1], ["", "src/node.dart",, B, {
    "^": "",
    Node: {
      "^": "Object;name,opr,end",
      get_node$1: function(node_name) {
        var t1, t2, _i, n;
        if (this.name === node_name)
          return this;
        for (t1 = this.opr, t2 = t1.length, _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          n = t1[_i].get_node$1(node_name);
          if (n != null)
            return n;
        }
        return;
      ...
      toString$0: function(_) {
        var t1, t2, t3, str, _i, o;
        for (t1 = this.opr, t2 = t1.length, t3 = this.name, str = "", _i = 0; _i < t1.length; t1.length === t2 || (0, H.throwConcurrentModificationError)(t1), ++_i) {
          o = t1[_i];
          str += H.S(t3) + " -> " + o.toString$0(0) + " \n";
        }
        return str;
      }
    }
    ...
    Tree: {
      "^": "Object;0head",
      addOpr$3: function($name, cost, nodes) {
        var n, t1, t2, t3, _i;
        n = this.head.get_node$1($name);
        t1 = H.setRuntimeTypeInfo([], [B.Node]);
        for (t2 = nodes.length, t3 = [V.Opr], _i = 0; _i < nodes.length; nodes.length === t2 || (0, H.throwConcurrentModificationError)(nodes), ++_i)
          C.JSArray_methods.add$1(t1, new B.Node(nodes[_i], H.setRuntimeTypeInfo([], t3), false));
        C.JSArray_methods.add$1(n.opr, new V.Opr(t1, cost));
      },
      toString$0: function(_) {
        return this.head.toString$0(0);
      }
    }
  }]];
